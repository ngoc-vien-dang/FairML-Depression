...
This file contains functions for auditing algorithmic bias.
"""
import numpy as np
...
def benchmark(X_train,y_train,X_test,y_test,cls_mdls,model_path,unprivileged_groups,privileged_groups,\
